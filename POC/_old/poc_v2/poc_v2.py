import json
from poc_lib_v2 import rising, end_transaction, rapid_falling, stops, reduce_from, price_check

from poc_lib_v2 import DATE, BETWEEN

stocks = ['WHITF','TAL','CEIX','HKD','APE','MSFT','AFRM','COIN','TWLO','WEGE3.SA']
for stock in stocks:

#### leitura de arquivo
    file = open(f'stock_data/{stock}.json')
